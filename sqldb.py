...
create_text = """ CREATE TABLE IF NOT EXISTS planes ( id integer primary key autoincrement, ts date,flight text, hex text, tail text, alt  integer, track float, nearest_point float, lat  float, long float ); """ 
